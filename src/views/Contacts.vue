         ...
         <ion-page>
            <ion-header class="header_am Mobo-header">
               ...
               <ion-row class="ion-justify-content-center ion-padding-start ion-padding-end ion-padding-bottom">
                  <ion-col size="12">
                     <div class="BtnBlock">
                        <ion-button v-if="selectedSegment == 'contacts'" class="import_csv"
                           @click="() => router.push('/import-CSVExcel')">Import CSV/Excel</ion-button>
                        <ion-button v-if="selectedSegment == 'contacts'" class="import_csv"
                           @click="() => router.push('/add-contact')">Add Contact</ion-button>
                        <ion-button v-if="selectedSegment == 'groups'" class="import_csv craete-group-btn"
                           @click="() => router.push('/create-group')">Create Group</ion-button>
                     </div>
                  </ion-col>
               </ion-row>
            </ion-header>
            ...
            <ion-content :fullscreen="true">
               ...
               <div v-if="selectedSegment == 'groups'" class="ion-padding-start ion-padding-end">
                  <div class="contactlist contactlist-GROUP">
                     <div class="contact_name_list">
                        <ion-list>
                           <ion-item lines="none" class="list_cons">
                  ...
                  <ion-row class="ion-justify-content-center contact-footer">
                     <ion-col size="12">
                        <div class="BtnBlock">
                           ...
                           <ion-button shape="round" type="default" @click="()=>router.push('/choose-template')"
                              class="next_btn _gary-outline-btn">Cancel</ion-button>
                        </div>
                     </ion-col>
                  </ion-row>
               </ion-toolbar>
      ...
      <div v-if="isIpad">
        ...
        <ion-col size="6">
            ...
            <ion-button class="import_csv" @click="() => router.push('/add-contact')">Add Contact</ion-button>
               ...
               <ion-row class="ContactList-btnBox ion-justify-content-end ion-padding">
                  <ion-col size="6" class="d-flex ion-justify-content-end ion-no-padding">
                     <ion-button v-if="selectedSegment == 'contacts'" class="import_csv" @click="excel">Import CSV/Excel
                     </ion-button>
                     <ion-button v-if="selectedSegment == 'contacts'" class="import_csv" @click="addacontact">Add
                        Contact</ion-button>
                     <ion-button v-if="selectedSegment == 'groups'" class="import_csv" @click="creategroup">Create Group
                     </ion-button>
                  </ion-col>
               </ion-row>
            </ion-header>
            ...
            <ion-content :fullscreen="true">
               <div v-if="selectedSegment == 'contacts'" class="ion-padding-start ion-padding-end contacts-inner-box">
                  <div class="contactlist contactlist-ipad contactlist-desk">
                     ...
                     <div class="contact_name_list">
                        ...
                        <ion-row class="main_conipad main-cont-desk">
                           <ion-col size="3">
                              <ion-item lines="none">
                                 <ion-checkbox color="primary" checked slot="start"></ion-checkbox>
                                 <ion-label>Andrew Symonds</ion-label>
               ...
               <div v-if="selectedSegment == 'groups'"
                  class="ion-padding-start ion-padding-end ion-padding-top contacts-inner-box">
                  <div class="contactlist contactlist-ipad contactlist-desk">
      ...
      <div v-if="isDesktop">
         <ion-page>
            ...
            <ion-content :fullscreen="true" class="back_white_f2">
               <div v-if="selectedSegment == 'contacts'" class="ion-padding-horizontal Contacts-List-Info">
                  <div class="contactlist contactlist-desk">
                     ...
                     <div class="contact_name_list">
                        ...
                        <ion-row class="main_conipad  main-cont-desk">
                           ...
                           <ion-col size="3" class="ion-padding-end">
                              <div class="insd">
                                 <p>13 Green Park Avenues Kassel 11015 Germany</p>
                              </div>
                           </ion-col>
                     ...
                     <div class="contact_name_list">
                        <ion-row class="main_conipad  main-cont-desk">
                           <ion-col size="3">
                              <ion-item lines="none">
                                 <ion-checkbox color="primary" checked slot="start"></ion-checkbox>
                                 <ion-label>Bryan Adams</ion-label>
                              </ion-item>
                           </ion-col>

                           <ion-col size="3" class="ion-padding-end">
                              <div class="insd">
                                 <p>12 Model Town Road Berlin 11017 Germany</p>
                              </div>
                           </ion-col>
                        ...
                        <ion-row class="main_conipad  main-cont-desk">
                           <ion-col size="3">
                              <ion-item lines="none">
                                 <ion-checkbox color="primary" checked slot="start"></ion-checkbox>
                                 <ion-label>Benjamin Williams</ion-label>
                              </ion-item>
                           </ion-col>

                           <ion-col size="3" class="ion-padding-end">
                              <div class="insd">
                                 <p>133 Civil Lines GT Road Munich 11017 Germany</p>
                              </div>
                           </ion-col>
                        ...
                        <ion-row class="main_conipad  main-cont-desk">
                           <ion-col size="3">
                              <ion-item lines="none">
                                 <ion-checkbox color="primary" checked slot="start"></ion-checkbox>
                                 <ion-label>Brett D'souza</ion-label>
                              </ion-item>
                           </ion-col>
               ...
               <div v-if="selectedSegment == 'groups'" class="ion-padding-horizontal">
                  <div class="contactlist contactlist-desk">
                     <div class="contact_name_list create-groups-list padd_mobils">
                        <ion-row class="main_conipad main-cont-desk ion-justify-content-between">
                           <ion-col size="3">
