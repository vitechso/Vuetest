                            ...
                            <ion-col size="12" class="ion-padding-horizontal">
                                <div class="Page-header">
                                    <div class="Page-Title">
                                        <img @click="()=>router.push('/all-letters')"
                                    ...
                                    <div class="TopHeader-icon">
                                        <ion-buttons class="menu-btn header-icon">
                                            <ion-menu-button class="primary_arrow_inner"><img
                                                    src="assets/images/menu.svg" /></ion-menu-button>
                                        </ion-buttons>

                                        <div class="search_icon header-icon">
                                            <img @click="()=>router.push('/preview')"
                                                src="assets/images/send_share.svg" />
                                        </div>
                                    </div>
                                </div>
                            </ion-col>
                        ...
                        <ion-row class="row_01 b_p ion-padding-vertical">
                            ...
                            <ion-col size="6" class="ion-no-padding">
                                <div class="btn_ajj ion-text-right">
                                    <ion-button shape="round" type="button"
                                        @click="() => router.push('/changesignature')">Adjust</ion-button>
                                </div>
                            </ion-col>
                        </ion-row>
                        ...
                        <ion-row class="ion-align-items-center bar_c">
                            ...
                            <ion-col size="3">
                                <div class="user_img">
                                    ...
                                    <div class="arrow_ds tooltip left" data-before-content="More Option">
                            ...
                            <ion-row class="s_bar lettes_desk">
                                <ion-col size="12">
                                    <div class="ion-text-left ipad_flx desk_flx">
                                        ...
                                        <div class="black-down-arrow tooltip right" data-before-content="More Option">
                                            ...
                                            <ion-col size="12" class="ion-no-padding">
                                                <div class="board-icon">
                                                    <div class="board-left">
                                                        ...
                                                        <div :class="styleClass!=''?'hideBottom':''"
                                                            class="align_icons">
                                            ...
                                            <ion-row class="Form-subject-row">
                                                <ion-col size="12" class="pr-0 pl-0">
                                                    <div class="Form-subject-block">
                                                        <div class="Form-subject">
                                                            <h5>From</h5>
                                                            <p class="fontlight f-20">John Anderson 243 Park Hall
                                            ...
                                            <ion-row class="Form-subject-row">
                                                <ion-col size="12" class="pr-0 pl-0">
                                                    <div class="Form-subject-block">
                                                        <div class="Form-subject">
                                                            <h5>To</h5>
                                                            <p class="fontlight f-20">Justin Shepp 564 Urban Estate
      ...
      toolbar: 'bold italic underline | alignleft aligncenter alignright alignjustify'
                                ...
                                <ion-col size="6" class="d-flex ion-align-items-center relative Lp-bg">
                                    ...
                                    <div class="desktop_pages_of">
                                        ...
                                        <p>Page 1 of 2</p>
                                        <div class="arrow tooltip right" data-before-content="Next">
