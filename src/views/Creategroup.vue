            ...
            <ion-toolbar>
                <ion-row class="ion-align-items-center">
                    ...
                    <ion-col size="9">
                        ...
                        <span class="title_top">Create Group</span> 
                        </div>
                    </ion-col>
                ...
                <ion-row class="ion-justify-content-center contact-footer">
                    <ion-col size="12">
                        <div class="BtnBlock">
                            ...
                            <ion-button shape="round" type="default" @click="()=>router.push('/choose-template')" class="MakeDefault-btn _gary-outline-btn">Cancel</ion-button>
                        </div>
                    </ion-col>
                </ion-row>
            </ion-toolbar>
...
<div v-if="isDesktop">
    <ion-page> 
        ...
        <ion-content :fullscreen="true">
            <div class="main_setting ion-padding-start">
...
<script lang="ts">
import { IonPage,IonHeader, IonContent, IonToolbar, modalController  } from '@ionic/vue'
