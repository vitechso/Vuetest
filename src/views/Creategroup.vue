   ...
   <ion-page>
            ...
            <ion-header class="header_am Mobo-header">
               ...
               <ion-row class="ion-padding-top">
                  <ion-col size="12" class="ion-padding-start ion-padding-end">
                     <ion-searchbar placeholder="Group Name" class="ion-no-padding search_bts GroupSearch">
                     </ion-searchbar>
                  </ion-col>
               </ion-row>
                     ...
                     <ion-col size="12">
                        <div class="BtnBlock">
                           ...
                           <ion-button shape="round" type="default" @click="()=>router.push('/choose-template')"
                              class="MakeDefault-btn btn50 _gary-outline-btn">Cancel</ion-button>
                        </div>
                     </ion-col>
                  </ion-row>
               </ion-toolbar>
      ...
      <div v-if="isIpad">
         <ion-page>
            <ion-header class="ipad_topbar dark333">
               ...
               <ion-row class="ion-padding-top">
                  <ion-col size="12" class="ion-padding-start ion-padding-end">
                     <ion-searchbar placeholder="Group Name"
                        class="ion-no-padding search_bts GroupSearch hans_ipad cntct-search-desk"></ion-searchbar>
                  </ion-col>
               </ion-row>
            ...
            <ion-content :fullscreen="true">
               <div class="main_setting ion-padding-start contacts-inner-box">
                  <div class="Contacts-List-Info Group-list-container">
                     <div class="contactlist contactlist-desk contactlist-ipad">
                        <div class="alpha">
                           <p>A</p>
                        </div>
                        <div class="contact_name_list">
                     ...
                     <ion-row class="ion-justify-content-center ion-padding ion-margin-vertical">
                        <ion-col size="12">
                           <div class="BtnBlock">
                              <ion-button shape="round" class="MakeDefault-btn">Create Group</ion-button>
      ...
      <div v-if="isDesktop">
         <ion-page>
            ...
            <ion-content :fullscreen="true">
               <div class="main_setting ion-padding-horizontal">
                  <div class="Contacts-List-Info Group-list-container">
